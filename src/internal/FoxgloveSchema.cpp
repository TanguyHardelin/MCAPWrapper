...
std::string compressed_image_schema = R"({
...
{
    return compressed_image_schema;
}

std::string log_schema = R"({
  "title": "foxglove.Log",
...
std::string scene_update_schema = R"({
...
{
    return scene_update_schema;
}

std::string frame_transform_schema = R"({
...
{
    return frame_transform_schema;
}

std::string camera_calibration_schema = R"({
...
{
    return camera_calibration_schema;
}

std::string poses_in_frame_schema = R"({  "title": "foxglove.PosesInFrame",
...
{
    return poses_in_frame_schema;
}

std::string image_annotation_schema = R"({
...
std::string get_image_annotation_schema(){
  return image_annotation_schema;
}