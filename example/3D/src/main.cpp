...
int main(int argc, char **argv){
    ...
    for(unsigned i=0; i<20; i++){
        ...
        mcap_wrapper::write_3d_object("cube", std::chrono::system_clock::now().time_since_epoch().count());
        // Create sphere:
        ...
        mcap_wrapper::write_3d_object("sphere", std::chrono::system_clock::now().time_since_epoch().count());
        // Create arrow:
        ...
        mcap_wrapper::write_3d_object("arrow", std::chrono::system_clock::now().time_since_epoch().count());
        // Create cylinder:
        ...
        mcap_wrapper::write_3d_object("cylinder", std::chrono::system_clock::now().time_since_epoch().count());
        // Create triangle:
        ...
        mcap_wrapper::write_3d_object("triangle", std::chrono::system_clock::now().time_since_epoch().count());
