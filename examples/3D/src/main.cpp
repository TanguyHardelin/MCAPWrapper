...
int main(int argc, char **argv){
    ...
    for(unsigned i=0; i < 20; i++){
        ...
        cube_position(0,3) = position;
        mcap_wrapper::create_3D_object("cube");
        mcap_wrapper::add_cube_to_3d_object("cube", cube_position, {1, 1, 1}, {255.0/255,0,0,255.0/255});
        ...
        sphere_position(1,3) = position;
        mcap_wrapper::create_3D_object("sphere");
        mcap_wrapper::add_sphere_to_3d_object("sphere", sphere_position, {1, 1, 1}, {255.0/255,255.0/255,0,255.0/255});
        ...
        arrow_position(1,3) = position * 2;
        mcap_wrapper::create_3D_object("arrow");
        mcap_wrapper::add_arrow_to_3d_object("arrow", arrow_position, 1, 0.1, 0.2,0.15, {0,25/255,100/255,1});
        ...
        cylinder_position(0,3) = position * 2;
        mcap_wrapper::create_3D_object("cylinder");
        mcap_wrapper::add_cylinder_to_3d_object("cylinder", cylinder_position, 1, 0.5, {1,1,1}, {25/255,0,121/255,1});
        ...
        triangle_position(2,3) = position ;
